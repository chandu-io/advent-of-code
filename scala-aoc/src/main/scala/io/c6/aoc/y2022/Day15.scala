...
@main def _2022_15: Unit = Day15()

object Day15 extends BaseSolution(_2022, _15):
  protected def part1Solution: Seq[String] => Unit = input =>
    println("Part 1 has input size: " + input.length)

  protected def part2Solution: Seq[String] => Unit = input =>
    println("Part 2 has input size: " + input.length)
